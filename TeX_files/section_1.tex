...
\begin{tcolorbox}[colback=yellow!10!white, colframe=red!50!black, title=NOTE]
	The S.100 is not suitable por DC or battery operation
\end{tcolorbox}
...
To take this in order:
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\linewidth]{./Figures/figure_1_output_channels.png} % Ruta de la imagen
		\BeginAccSupp{ActualText=PAN OUTPUTS INDIVIDUAL OUTPUTS 1-4 L R 5-8 L R PAN INDIVIDUAL OUTPUTS 1 2 3 4 5 6 7 8 (much simplified diagram) FROM OUTPUT CHANNEL AMPS}
		\caption[Simplified diagram of output channels]{[Simplified diagram of output channels]}
		\EndAccSupp{}
		\label{fig:figure_1_output_channels}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.6\linewidth]{./Figures/figure_2_plugs_sockets_cannon.png} % Ruta de la imagen
		\BeginAccSupp{ActualText=\detokenize{OUTPUTS INPUTS 1 = CHASSIS SCREEN & GRND. 2=SIGNAL 'A' 3=SIGNAL 'B' Pins Sockets}}
		\caption[Plugs + sockets (cannon)]{Plugs + sockets (cannon) NB. Some models have jack socket inputs + outputs}
		\EndAccSupp{}
		\label{fig:figure_2_plugs_sockets_cannon}
	\end{figure}
